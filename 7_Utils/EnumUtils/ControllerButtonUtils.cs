...
namespace EasyOffset {
    internal static class ControllerButtonUtils {
        ...
        private static readonly Dictionary<ControllerButton, string> OculusVrModeOculusButtons = new() {
        ...
        private static readonly Dictionary<ControllerButton, string> OculusOpenVrButtons = new() {
            [ControllerButton.GripButton] = "Grip button",
        ...
        public static Dictionary<ControllerButton, string> GetAvailableOptions(ControllerType controllerType, bool isVrModeOculus) {
            switch (controllerType) {
                ...
                case ControllerType.OculusQuest2:
                case ControllerType.OculusRiftS:
                case ControllerType.OculusCV1: return isVrModeOculus ? OculusVrModeOculusButtons : OculusOpenVrButtons;
